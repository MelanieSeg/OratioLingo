...
class _Nivel1ScreenState extends State<Nivel1Screen>
  ...
  final totalEjercicios = 5; // Solo A, B, C, D, E
  ...
  Map<String, dynamic> estadoEmparejamiento = {
    'parejas': [
      {'senia': 'a', 'letra': 'A', 'emparejada': false, 'error': false},
      {'senia': 'b', 'letra': 'B', 'emparejada': false, 'error': false},
      {'senia': 'c', 'letra': 'C', 'emparejada': false, 'error': false},
      {'senia': 'd', 'letra': 'D', 'emparejada': false, 'error': false},
      {'senia': 'e', 'letra': 'E', 'emparejada': false, 'error': false},
    ],
  ...
  final List<Map<String, dynamic>> ejercicios = [
    ...
    {
      'tipo': 'seleccionMultiple',
      'titulo': '¿Cuál es la seña para la letra D?',
      'senia': 'd',
      'opciones': ['C', 'D', 'E'],
      'correcta': 'D',
      'hint': 'El dedo índice apunta hacia arriba formando una "D"',
      'completado': false,
    },
    {
      'tipo': 'escribir',
  ...
  final Map<String, String> hints = {
    'a': 'El puño cerrado con el pulgar al lado, como la letra "A"',
    'b': 'La mano abierta con dedos juntos hacia arriba, como "B"',
    'c': 'La mano forma una "C" curvada',
    'd': 'El dedo índice apunta hacia arriba, otros dedos cerrados',
    'e': 'Los dedos se doblan hacia la palma, como una garra',
  };
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Has practicado las letras A, B, C, D y E',
              style: TextStyle(
                fontSize: 16,
                color: theme.textTheme.bodyMedium?.color,
              ),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const Expanded(
                  child: Text(
                    '¡Nivel 1 completado! Nivel 2 desbloqueado',
